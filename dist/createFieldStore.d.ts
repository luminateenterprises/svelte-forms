...
export declare function createFieldOject<T>(
	name: string,
	value: T,
...
export declare function getErrors<T>(
...
export declare function processField<T>(
	field: Field<T>,
	validations?: FieldValidation[],
	partialField?: Partial<Field<T>>
): Field<T>;

export declare function createFieldStore<T>(
	name: string,
	v: T,
	validators: Validator[],
